...
export const checkValidHex = (hexCode) => {
	const pattern = /^#?[0-9a-fA-F]+$/;
	return pattern.test(hexCode);
};

export const getCommonColorObj = (hexCode) => {
	if (!checkValidHex(hexCode)) return getCommonColorObj('#ffffff');
